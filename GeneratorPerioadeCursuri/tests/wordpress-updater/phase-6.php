...
$assert($version === '2.6.2', 'manifest version must be 2.6.2');
$assert(($manifest['releaseDate'] ?? null) === '2026-08-20', 'manifest release date must match this release');
...
$assert(is_file($archivePath), 'the 2.6.2 installable ZIP must exist');
