...
$assert($version === '2.3.0', 'manifest version must be 2.3.0');
$assert(($manifest['releaseDate'] ?? null) === '2026-07-16', 'manifest release date must match this release');
...
$assert(is_file($archivePath), 'the 2.3.0 installable ZIP must exist');
