    ...
    return class extends DetailRecordView {
        ...
        async actionGenerate() {
            if (this.model.get('generatedAt')) {
                Espo.Ui.warning(this.translate('alreadyGenerated', 'messages', 'GeneratorPerioadeCursuri'));
            ...
            try {
                const result = await Espo.Ajax.postRequest('GeneratorPerioadeCursuri/generate', payload);
                ...
                if (result.warningMessage) {
                    ...
                    Espo.Ui.success(result.message || this.translate('generateRequestReceived', 'messages', 'GeneratorPerioadeCursuri'));
                }
        ...
        async actionExportXlsx() {
            ...
            try {
                const result = await Espo.Ajax.postRequest('GeneratorPerioadeCursuri/' + this.model.id + '/exportXlsx', {});
        ...
        getGenerateErrorMessage(xhr) {
            const fallback = this.translate('generateFailed', 'messages', 'GeneratorPerioadeCursuri');
