...
class WordConversionService
{
     ...
     */
    public function convert(string $id, ?object $input = null, string $entityType = 'GeneratorPerioadeCursuriWordMatcher'): array
    {
        ...
        $convertedAttachment
            ->setName($this->createFileName((string) ($record->get('name') ?? 'generator-perioade-cursuri')))
     ...
     * @return array<string, mixed>
     */
    public function preview(string $id, string $entityType = 'GeneratorPerioadeCursuriWordMatcher'): array
    {
    ...
    private function readScheduleRows(string $contents): array
    {
        ...
        $path = tempnam(sys_get_temp_dir(), 'generator-perioade-cursuri-word-schedule-');
    ...
    private function applyMatches(string $wordBytes, array $scheduleRows, ?array $matches = null): array
    {
        ...
        $path = tempnam(sys_get_temp_dir(), 'generator-perioade-cursuri-word-docx-');
    ...
    private function readWordRows(string $wordBytes): array
    {
        ...
        $path = tempnam(sys_get_temp_dir(), 'generator-perioade-cursuri-word-preview-');
    ...
    {
        $base = trim($recordName) !== '' ? $recordName : 'generator-perioade-cursuri';
        $base = preg_replace('/[^A-Za-z0-9._-]+/', '-', $base) ?: 'generator-perioade-cursuri';
        $base = trim($base, '-_.') ?: 'generator-perioade-cursuri';
