...
class PostCompareWord implements Action
{
    public function __construct(private WordComparisonService $service) {}
    ...
    public function process(Request $request): Response
    {
        ...
        return ResponseComposer::json($this->service->compare($id));
    }
}
