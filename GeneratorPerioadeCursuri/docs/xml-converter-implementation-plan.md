...
- Automatically start the download after successful generation, matching the Django page.
...
- A successful request returns or resolves a downloadable XML file immediately.
...
- automatic download after successful generation;
...
- Automatically open the returned download URL.
...
| Download | `application/xml`; current-year filename; automatic and manual download |
