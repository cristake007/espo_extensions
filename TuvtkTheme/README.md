...
```bash
./build.sh --extension ./TuvtkTheme --zip 1.0.6 files scripts
```

The resulting `dist/tuvtk-theme-1.0.6.zip` can be uploaded from
...
Use the `tuvtk-theme-1.0.6.zip` release asset when downloading the extension
