...
```bash
./build.sh --extension ./TuvtkTheme --zip 1.0.9 files scripts
```

The resulting `dist/tuvtk-theme-1.0.9.zip` can be uploaded from
...
Use the `tuvtk-theme-1.0.9.zip` release asset when downloading the extension
