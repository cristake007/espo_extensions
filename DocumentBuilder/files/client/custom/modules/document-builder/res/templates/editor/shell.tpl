            ...
            <aside class="document-builder-editor__inspector" aria-label="{{translate 'Inspector' category='labels' scope='DocumentBuilderTemplate'}}">
                ...
                <fieldset class="document-builder-editor__style-controls">
                    ...
                    <div class="document-builder-editor__settings-grid">
                        <label>{{translate 'Font Size' category='labels' scope='DocumentBuilderTemplate'}}<input class="form-control input-sm" type="number" min="1" max="512" step="0.1" value="{{selectedFlowNode.inspectorStyle.fontSize.value}}" data-style-setting="fontSize"></label>
                        <label>{{translate 'Line Height' category='labels' scope='DocumentBuilderTemplate'}}<input class="form-control input-sm" type="number" min="0.5" max="5" step="0.1" value="{{selectedFlowNode.inspectorStyle.lineHeight}}" data-style-setting="lineHeight"></label>
                        <label>{{translate 'Letter Spacing' category='labels' scope='DocumentBuilderTemplate'}}<input class="form-control input-sm" type="number" min="-20" max="100" step="0.1" value="{{selectedFlowNode.inspectorStyle.letterSpacing.value}}" data-style-setting="letterSpacing"></label>
                        <label>{{translate 'Opacity' category='labels' scope='DocumentBuilderTemplate'}}<input class="form-control input-sm" type="number" min="0" max="1" step="0.05" value="{{selectedFlowNode.inspectorStyle.opacity}}" data-style-setting="opacity"></label>
                    </div>
                    <div class="document-builder-editor__settings-grid">
                        <label>{{translate 'Text Color' category='labels' scope='DocumentBuilderTemplate'}}<input class="form-control input-sm" type="color" value="{{selectedFlowNode.inspectorStyle.color}}" data-style-setting="color"></label>
                        <label>{{translate 'Background' category='labels' scope='DocumentBuilderTemplate'}}<input class="form-control input-sm" type="color" value="{{selectedFlowNode.inspectorStyle.backgroundColor}}" data-style-setting="backgroundColor"></label>
                    </div>
                    <div class="document-builder-editor__settings-grid">
                        <label>{{translate 'Weight' category='labels' scope='DocumentBuilderTemplate'}}<select class="form-control input-sm" data-style-setting="fontWeight"><option value="normal" {{#if selectedFlowNode.styleChoices.weightNormal}}selected{{/if}}>Normal</option><option value="bold" {{#if selectedFlowNode.styleChoices.weightBold}}selected{{/if}}>Bold</option><option value="400" {{#if selectedFlowNode.styleChoices.weight400}}selected{{/if}}>400</option><option value="700" {{#if selectedFlowNode.styleChoices.weight700}}selected{{/if}}>700</option></select></label>
                        <label>{{translate 'Font Style' category='labels' scope='DocumentBuilderTemplate'}}<select class="form-control input-sm" data-style-setting="fontStyle"><option value="normal" {{#if selectedFlowNode.styleChoices.fontNormal}}selected{{/if}}>Normal</option><option value="italic" {{#if selectedFlowNode.styleChoices.fontItalic}}selected{{/if}}>Italic</option></select></label>
                        <label>{{translate 'Decoration' category='labels' scope='DocumentBuilderTemplate'}}<select class="form-control input-sm" data-style-setting="textDecoration"><option value="none" {{#if selectedFlowNode.styleChoices.decorationNone}}selected{{/if}}>None</option><option value="underline" {{#if selectedFlowNode.styleChoices.decorationUnderline}}selected{{/if}}>Underline</option></select></label>
                        <label>{{translate 'Transform' category='labels' scope='DocumentBuilderTemplate'}}<select class="form-control input-sm" data-style-setting="textTransform"><option value="none" {{#if selectedFlowNode.styleChoices.transformNone}}selected{{/if}}>None</option><option value="uppercase" {{#if selectedFlowNode.styleChoices.transformUpper}}selected{{/if}}>Uppercase</option><option value="lowercase" {{#if selectedFlowNode.styleChoices.transformLower}}selected{{/if}}>Lowercase</option><option value="capitalize" {{#if selectedFlowNode.styleChoices.transformCapitalize}}selected{{/if}}>Capitalize</option></select></label>
                    </div>
                    ...
                    <div class="form-group"><label>{{translate 'Vertical Alignment' category='labels' scope='DocumentBuilderTemplate'}}<select class="form-control input-sm" data-style-setting="verticalAlignment"><option value="start" {{#if selectedFlowNode.styleChoices.valignStart}}selected{{/if}}>Start</option><option value="center" {{#if selectedFlowNode.styleChoices.valignCenter}}selected{{/if}}>Center</option><option value="end" {{#if selectedFlowNode.styleChoices.valignEnd}}selected{{/if}}>End</option></select></label></div>
                    <div class="document-builder-editor__settings-grid">
                        <label>{{translate 'Width (mm)' category='labels' scope='DocumentBuilderTemplate'}}<input class="form-control input-sm" type="number" min="0" max="2000" step="0.1" value="{{selectedFlowNode.inspectorStyle.width.value}}" data-style-setting="width"></label>
                        <label>{{translate 'Height (mm)' category='labels' scope='DocumentBuilderTemplate'}}<input class="form-control input-sm" type="number" min="0" max="2000" step="0.1" value="{{selectedFlowNode.inspectorStyle.height.value}}" data-style-setting="height"></label>
                        <label>{{translate 'Border Width (pt)' category='labels' scope='DocumentBuilderTemplate'}}<input class="form-control input-sm" type="number" min="0" max="512" step="0.1" value="{{selectedFlowNode.inspectorStyle.border.width.value}}" data-style-setting="borderWidth"></label>
                        <label>{{translate 'Border Color' category='labels' scope='DocumentBuilderTemplate'}}<input class="form-control input-sm" type="color" value="{{selectedFlowNode.inspectorStyle.border.color}}" data-style-setting="borderColor"></label>
                    </div>
                    <div class="form-group"><label>{{translate 'Border Style' category='labels' scope='DocumentBuilderTemplate'}}<select class="form-control input-sm" data-style-setting="borderStyle"><option value="none">None</option><option value="solid">Solid</option><option value="dashed">Dashed</option><option value="dotted">Dotted</option><option value="double">Double</option></select></label></div>
                </fieldset>
